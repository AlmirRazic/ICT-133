...
if ($type == 'insert')
{
    $query = "INSERT INTO `t_teacher` (`idteacher`, `teaFirstname`, `teaLastname`, `teaGender`, `teaNickname`, `teaOriginNickname`, `idSection`) VALUES ('NULL', '$name' , '$lastName', '$sex', '$nickName', '$desc', '$section')";
}
...
elseif ($type == 'edit')
{
    ...
    $query = "UPDATE `t_teacher` SET `teaFirstname` = '$name', `teaLastname` = '$lastName' , `teaGender` = '$sex', `teaNickname` = '$nickName', `teaOriginNickname` = '$desc' WHERE `t_teacher`.`idteacher` = $id";
}
