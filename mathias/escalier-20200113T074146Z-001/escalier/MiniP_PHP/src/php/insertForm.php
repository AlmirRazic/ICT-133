        ...
        <?php
            if (isset($_SESSION['login']))
            {
                ...
                <section>
                    <div id="form">
                        <!--Début du formulaire-->
                        <form action="checkForm.php?type=insert&id=<?php echo $_GET['idTeacher']?>" method="POST">
                            Nom
                            ...
                            <input type="radio" name="gender" value="Homme" checked="checked">Homme
                            <input type="radio" name="gender" value="Femme">Femme
                            <input type="radio" name="gender" value="Autre">Autre...<br><br>
